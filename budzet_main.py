...
class StartMainWindow(QtWidgets.QMainWindow):
    ...
    def update_total(self):
        ...
        t_rsd = i_rsd - o_rsd
        t_eur = i_eur - o_eur
        self.ui.lbl_rsd_income.setText(self.conn.lang("main_lbl_income", self.active_lang) + str(i_rsd))
        self.ui.lbl_rsd_outcome.setText(self.conn.lang("main_lbl_outcome", self.active_lang) + str(o_rsd))
        self.ui.lbl_eur_income.setText(self.conn.lang("main_lbl_income", self.active_lang) + str(i_eur))
        self.ui.lbl_eur_outcome.setText(self.conn.lang("main_lbl_outcome", self.active_lang) + str(o_eur))
        self.ui.lbl_rsd_total.setText(self.conn.lang("main_lbl_total", self.active_lang) + str(t_rsd))
        self.ui.lbl_eur_total.setText(self.conn.lang("main_lbl_total", self.active_lang) + str(t_eur))
